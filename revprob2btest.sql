...
WHERE ((LINE_TYPE IN ('INV', 'CM') AND date(invoice_date) BETWEEN '2023-07-01' AND '2023-07-25')
       OR (LINE_TYPE ='SO' AND date(SALES_ORDER_DATE) BETWEEN '2023-07-01' AND '2023-07-25'))
